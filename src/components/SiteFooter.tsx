    ...
    <footer className="border-t border-gold/20 bg-onyx">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
              A newly founded digital auction house for antiques, classic motorcars and
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-2 text-xs text-muted-foreground sm:flex-row">
          <p>© {new Date().getFullYear()} The Gilded Auction House. All rights reserved.</p>
          <p className="tracking-widest uppercase">India</p>
        </div>
      </div>
    </footer>
  );
